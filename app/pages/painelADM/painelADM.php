  ...
  <div class="container-fluid bg-blue mb-30" style="margin-bottom: 0 !important;">
    <div class="row px-xl-5" style="padding-left: 0 !important;">
      <div class="col-lg-2 d-lg-block" style="padding-left: 0 !important;">
        <a class="btn d-flex align-items-center justify-content-between w-100" data-toggle="collapse" href="#navbar-vertical" style="height: 65px; padding: 0; background-color:#fff; border-radius:0 !important;">
