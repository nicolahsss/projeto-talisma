    ...
    <div class="container-menu">
        <div class="menu-sidebar">
            <div class="row" style="height:52px; display: flex; justify-content:center; margin:1rem 0;">
                ...
                <h6 class="col-sm-12" style="display: flex; justify-content:center; align-items:center;">Gerenciar Produtos</h6>
            </div>

            <ul id="ulmenu">
                <li><a href="#" data-ir="opcoesPainelADM/opcoesGerenciaProdutos/listarProdutos">Listar Produtos</a></li>
