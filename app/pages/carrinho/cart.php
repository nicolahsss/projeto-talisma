                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
                                    <a href="../carrinho/cart.php" class="dropdown-item active">Shopping Cart</a>
                                    <a href="../checkout/checkout.php" class="dropdown-item">Checkout</a>
                                </div>
                            </div>
            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle"><img src="../../../public/assets/img/product-1.jpg" alt="" style="width: 50px;"> Product Name</td>
                        ...
                        <tr>
                            <td class="align-middle"><img src="../../../public/assets/img/product-2.jpg" alt="" style="width: 50px;"> Product Name</td>
                            <td class="align-middle">R$150</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                        ...
                        <tr>
                            <td class="align-middle"><img src="../../../public/assets/img/product-3.jpg" alt="" style="width: 50px;"> Product Name</td>
                            <td class="align-middle">R$150</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                        ...
                        <tr>
                            <td class="align-middle"><img src="../../../public/assets/img/product-4.jpg" alt="" style="width: 50px;"> Product Name</td>
                            <td class="align-middle">R$150</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
                        ...
                        <tr>
                            <td class="align-middle"><img src="../../../public/assets/img/product-5.jpg" alt="" style="width: 50px;"> Product Name</td>
                            <td class="align-middle">R$150</td>
                            <td class="align-middle">
                                <div class="input-group quantity mx-auto" style="width: 100px;">
                                    <div class="input-group-btn">
